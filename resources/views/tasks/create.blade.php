                    ...
                    <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                class="border rounded w-full px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="priority"
                                    class="border rounded w-full px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                                    <option value="3" {{ old('priority', 3) == 3 ? 'selected' : '' }}>高</option>
                                    <option value="2" {{ old('priority', 2) == 2 ? 'selected' : '' }}>中</option>
                                    <option value="1" {{ old('priority', 1) == 1 ? 'selected' : '' }}>低</option>
                                </select>
                            </div>
